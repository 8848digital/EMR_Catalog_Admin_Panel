...
module.exports = {
    ...
    addData: {
        ...
        rawQuery: `
            ...
            VALUES 
            ('yStckGrp', @Code, '', @Description, '', '', 0, '', 0, '', @ModUsr, GETDATE(), 0, '', 'Y', 'N')
        `,
    ...
    updateData: {
        ...
        rawQuery: `
            ...
            SET 
                ...
                ModDt = GETDATE(),
                ModTime = 0
            WHERE PTyp = 'yStckGrp' AND PMCd = @OldCode
        `,
    ...
    deleteData: {
        rawQuery: `DELETE FROM [${process.env.yDb}].[dbo].[yParam] WHERE PTyp = 'yStckGrp' AND PMCd = @Code`,
