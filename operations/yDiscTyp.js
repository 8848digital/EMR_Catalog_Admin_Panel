...
module.exports = {
    ...
    addData: {
        ...
        rawQuery: `
            ...
            VALUES 
            ('yDiscTyp', @Code, '', @Description, '', '', 0, '', 0, '', @ModUsr, GETDATE(), 0, '', 'Y', 'N')
        `,
    ...
    updateData: {
        ...
        rawQuery: `
            ...
            SET 
                ...
                ModDt = GETDATE(),
                ModTime = 0
            WHERE PTyp = 'yDiscTyp' AND PMCd = @OldCode
        `,
    ...
    deleteData: {
        rawQuery: `DELETE FROM [${process.env.yDb}].[dbo].[yParam] WHERE PTyp = 'yDiscTyp' AND PMCd = @Code`,
