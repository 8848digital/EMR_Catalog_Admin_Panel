...
module.exports = {
    label: 'Manage Ingredient Targets',
    ...
    addData: {
        ...
        rawQuery: `
            ...
            VALUES 
            ('yIngTrgt', @Code, '', @Description, '', '', 0, '', 0, '', @ModUsr, GETDATE(), 0, '', 'Y', 'N')
        `,
    ...
    updateData: {
        ...
        rawQuery: `
            ...
            SET 
                ...
                ModDt = GETDATE(),
                ModTime = 0
            WHERE PTyp = 'yIngTrgt' AND PMCd = @OldCode
        `,
    ...
    deleteData: {
        rawQuery: `DELETE FROM [${process.env.yDb}].[dbo].[yParam] WHERE PTyp = 'yIngTrgt' AND PMCd = @Code`,
